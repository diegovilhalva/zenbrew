...
const Menu = () => {
    return (
        <section className="pt-12 mb-16 xl:pt-16 xl:pb-36">
            <div className="container mx-auto">
                <div className="flex flex-col gap-4 mb-12 xl:mb-24">
                    ...
                    <p className="text-center max-w-[620px] mx-auto">
                        ...
                        tempore dolores saepe id minima et voluptatibus nam illo omnis
                        laborum!
                    </p>
                </div>
                    ...
                    <div className="w-full grid grid-cols-1 xl:grid-cols-2 gap-y-8 gap-x-16 place-content-center">
                        {
                            menuItems.map((item,index) => {
                                const {description,imgSrc,name,price} = item
                                return (
                                    <MenuItems description={description} imgSrc={imgSrc} name={name} price={price} key={index} />
                                )
                            })
                        }
                    </div>
